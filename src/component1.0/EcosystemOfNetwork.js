...
export default function  EcosystemOfNetwork(props) {
    ...
    const workImageArray = [{TLName:'Dheeraj Rathi', owner:'Koa & Sons', image:props.DR, Details:'Boost your product and\n' +
            'service\'s credibility by\n' +
            'adding testimonials from\n' +
            'your clients. People love\n' +
            'recommendations so\n' +
            'feedback from actual\n' +
            'clients is invaluable.'},
        {TLName:'Sudarshan Bajoria', owner:'Randelo Co.', image:props.DR, Details:'Boost your product and\n' +
                'service\'s credibility by\n' +
                'adding testimonials from\n' +
                'your clients. People love\n' +
                'recommendations so\n' +
                'feedback from actual\n' +
                'clients is invaluable.'},
        {TLName:'Devendra Jain', owner:'Anissa & Tam', image:props.DR, Details:'Boost your product and\n' +
                'service\'s credibility by\n' +
                'adding testimonials from\n' +
                'your clients. People love\n' +
                'recommendations so\n' +
